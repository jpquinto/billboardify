...
export default function Albums() {
  ...
  const [albumLeaderboard, setAlbumLeaderboard] = useState<
    ...
    const fetchData = async () => {
      try {
        ...
        if (
          ...
          setAlbumLeaderboard(null);
          setSummary(null);
          return;
        }

        setAlbumLeaderboard(response.data.leaderboard as AlbumLeaderboardEntry[]);
        ...
        <Container className="-translate-y-10 pt-20 relative overflow-visible">
          ...
          <div className="grid grid-cols-3 gap-x-10 relative min-h-screen">
            <div className="col-span-2">
              <AlbumsLeaderboard leaderboard={albumLeaderboard!} />
            </div>
